...
[FlyPE](https://poggit.pmmp.io/p/FlyPE/3.0.0) is a fly plugin for pocketmine that allows you to fly in survival mode when you run the fly command! There are many different features in the plugin that makes it special, and you should check them out!
...
You can find the config file for v2.0.0, v2.0.1, v2.0.2 [here](https://pastebin.com/raw/qgu9u1eJ)!

+ ![Config v3](https://img.shields.io/badge/Config-v3-orange?style=for-the-badge)
You can find the config file for v3.0.0 [here]()!
